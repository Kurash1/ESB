...
NDefines.NReligion.YEARLY_DOOM_INCREASE = 0.15								-- Multiplied by number of provinces
NDefines.NReligion.DOOM_REDUCTION_FROM_REFORMS = 0.20						-- This much less monthly doom (as a fraction of whole) for each reform passed
...
NDefines.NReligion.AUTHORITY_FROM_DEVELOPMENT = 0.01							-- Multiplied by development (affected by autonomy)
NDefines.NReligion.AUTHORITY_FROM_AUTONOMY = 0.1							-- Authority loss from granting autonomy
...
NDefines.NReligion.CHURCH_POWER_RATE_SCALE = 0.05								-- Scaling value for rate at which church power is gained.
...
NDefines.NReligion.YEARLY_HARMONY_INCREASE_WHEN_HARMONIZING = -3.5
...
NDefines.NReligion.APPOINT_CARDINAL_COOLDOWN = 5
