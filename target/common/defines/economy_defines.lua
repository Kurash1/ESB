...
NDefines.NEconomy.INFLATION_FROM_LOAN = 0.25						-- increase per loan
NDefines.NEconomy.INFLATION_FROM_PEACE_GOLD = 0.025				-- inflation per month of income taken in peace (also applied to province sales)
...
NDefines.NEconomy.BASE_INTERESTS = 5.0							-- Base interests
...
NDefines.NEconomy.BANK_LOAN_DURATION = 75						-- Default bank loan duration in months
...
NDefines.NEconomy.NAVAL_TECH_MAINTENANCE_IMPACT = 0.005
NDefines.NEconomy.TRADING_CITY_TRADING_RANGE_BOOST = 0.25