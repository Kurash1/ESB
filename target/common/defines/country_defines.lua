...
NDefines.NCountry.EXPLOIT_COOLDOWN_MONTHS = 12
...
NDefines.NCountry.MAX_PROVINCES_FOR_FREE_CITY = 10			-- A free city cannot have more provinces than this
...
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_1 = 121		-- Provinces for circumnavigation (Mistral)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_2 = 1887			-- Provinces for circumnavigation (Yokuda)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_3 = 3662			-- Provinces for circumnavigation (Laromedia)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_4 = 4477			-- Provinces for circumnavigation (Black Harbour)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_5 = 4436			-- Provinces for circumnavigation (Port Telvannis)
NDefines.NCountry.CIRCUMNAVIGATION_PROVINCE_6 = 1909			-- Provinces for circumnavigation (Lilmoth)
...
NDefines.NCountry.ADVISOR_COST_INCREASE_PER_YEAR = 0.0			-- yearly increase in price in percent
...
NDefines.NCountry.POWER_MAX = 1000								-- how much power can be stored at maximum.
...
NDefines.NCountry.PS_ESTABLISH_SIBERIAN_FRONTIER = 250
...
NDefines.NCountry.AGE_OF_ADULTHOOD = 21							-- _CDEF_AGE_OF_ADULTHOOD_
...
NDefines.NCountry.MONTHS_TO_CHANGE_CULTURE = 1					-- How many months it will take to change culture in a province per development.
...
NDefines.NCountry.STARTING_ARMY_SIZE_REBEL_THREAT = 0.15			-- Percentage of rebel threat added to percentage of force limit
...
NDefines.NCountry.REVOLT_TECH_IMPACT = 0 			-- % each tech increases size of rebels by this percent.
NDefines.NCountry.REVOLT_TECH_MORALE = 0			-- 1% per tech level
...
NDefines.NCountry.LIBERTY_DESIRE_RELATIVE_POWER = 35				-- Liberty desire from relative power to liege
...
NDefines.NCountry.HORDE_RAZE_TECH_POWER_DECREASE = 0.05 -- Per military tech above base level
NDefines.NCountry.RAZE_PROVINCE_COOLDOWN_YRS = 25
...
NDefines.NCountry.HORDE_UNITY_PER_RAZE = 0.25						-- Horde unity gained per development level razed.
...
NDefines.NCountry.INNOVATIVENESS_ENABLE_ANY_BEHIND_IN_TECH_PENALTY = 1	-- Enabled that if any tech is behind we apply the penalty. Turning this off will require you only to be ahead in one.
NDefines.NCountry.INNOVATIVENESS_ENABLE_PER_TECH_BEHIND_IN_TECH_PENALTY = 1 -- Enable that the penalty is applied for each tech we are behind in tech.
...
NDefines.NCountry.PROVOKE_REVOLT_SIZE_FACTOR = 1.0 -- Extra strength of revolt when using provoke revolt
NDefines.NCountry.PROVOKE_REVOLT_MIN_PROGRESS = 0.0	-- Minimum revolt progress to use provoke
NDefines.NCountry.UNREST_DECAY = 1.0

NDefines.NCountry.RETURN_PROVINCE_LIBERTY_MULTIPLIER = 1.0
NDefines.NCountry.HORDE_RAZE_TECH_POWER_DECREASE_MAX = 0.5
NDefines.NCountry.REVOLUTION_SPREAD_COUNT = 3			-- Max number of concurrent province revolution spread
NDefines.NCountry.REVOLUTION_DAILY_SPREAD = 0.5			-- How much the revolution spreads each day (progress is 0-100)
...
NDefines.NCountry.CLAIM_STRENGTH_AVERAGE_THRESHOLD = 66.6
NDefines.NCountry.CLAIM_STRENGTH_WEAK_THRESHOLD = 35
...
NDefines.NCountry.GREAT_PROJECT_MANPOWER_CONSTRUCTION_BOOST_AMOUNT_IN_DAYS = 1000
NDefines.NCountry.GREAT_PROJECT_MONEY_REQUIRED_FOR_CONSTRUCTION_BOOST = 1000
NDefines.NCountry.GREAT_PROJECT_MONEY_CONSTRUCTION_BOOST_AMOUNT_IN_DAYS = 750
NDefines.NCountry.GREAT_PROJECT_MOVE_COST_PER_DAY = 3

NDefines.NCountry.MIN_REGENCY_LEGITIMACY = 70
NDefines.NCountry.PS_ADD_TRIBAL_LAND = 100

NDefines.NCountry.ANCESTOR_PERSONALITY_LEVEL_1 = 5
NDefines.NCountry.ANCESTOR_PERSONALITY_LEVEL_2 = 10
NDefines.NCountry.ANCESTOR_COST = 500

NDefines.NCountry.MONTHS_OF_RESOURCES_FOR_FAVOURS = 7
NDefines.NCountry.CONCENTRATED_DEV_LIBERTY_DESIRE_PER_DEV = 2.5
NDefines.NCountry.CONCENTRATE_DEVELOPMENT_DEVELOPMENT_DECREASE = 0.10

NDefines.NCountry.PILLAGE_CAPITAL_DEVELOPMENT_DECREASE = 0.25
NDefines.NCountry.PILLAGE_CAPITAL_MAX_DEV_PILLAGED = 3
...
NDefines.NCountry.MIGRATORY_TRIBE_DEVASTATION_BURN = 1.0
...
NDefines.NCountry.COHESION_FEDERATION_MEMBER_WRONG_CULTURE = -0.1
NDefines.NCountry.COHESION_FEDERATION_MEMBER_CORRECT_CULTURE = 0.25
NDefines.NCountry.COHESION_FEDERATION_MEMBER_STRONGER = -0.5
NDefines.NCountry.COHESION_NEIGHBOURING_COLONIZER = 0.5
NDefines.NCountry.COHESION_FEDERATION_ADVANCEMENT = -0.1
NDefines.NCountry.COHESION_FEDERATION_MEMBER_STRONGER_WRONG_CULTURE = -0.35
...
NDefines.NCountry.FEDERATION_DESIRABILITY_SAME_CULTURE_GROUP = -25
NDefines.NCountry.FEDERATION_DESIRABILITY_LAND_BALANCE_MULTIPLIER = 25
NDefines.NCountry.FEDERATION_DESIRABILITY_STRONGER_THAN_LEADER_MALUS = -100
NDefines.NCountry.FEDERATION_DESIRABILITY_WANTS_ALLY = 25
NDefines.NCountry.FEDERATION_DESIRABILITY_WANTS_BEFRIEND = 25
NDefines.NCountry.FEDERATION_DESIRABILITY_WANTS_ANTAGONIZE = -50
NDefines.NCountry.FEDERATION_DESIRABILITY_WANTS_WEAKEN = -15
NDefines.NCountry.FEDERATION_DESIRABILITY_DONT_WANT_TO_CHANGE = -15
...
NDefines.NCountry.SIBERIAN_TRIBE_MIGRATION_BONUS = 100
NDefines.NCountry.SIBERIAN_TRIBE_MIGRATION_COOLDOWN_YEARS = 5

NDefines.NCountry.CLEAR_PROVINCE_VARIABLES_ON_CLEAR_OWNER = 1 	--set to 0 to avoid clearing province variables when a province's owner is set to none (modder request)
NDefines.NCountry.CLEAR_PROVINCE_FLAGS_ON_CLEAR_OWNER = 1 	--set to 0 to avoid clearing province flags when a province's owner is set to none (modder request)
NDefines.NCountry.CLEAR_PROVINCE_SAVED_NAMES_ON_CLEAR_OWNER = 1 	--set to 0 to avoid clearing province saved names when a province's owner is set to none (modder request)
NDefines.NCountry.CREATE_LEADER_FROM_CONSORT_PRESTIGE_COST = 10
	
NDefines.NCountry.SCORNFUL_INSULT_MULTIPLIER = 1.5
	
NDefines.NCountry.RANDOM_LUCKY_INSTITUTION_FACTOR = 1.5
	
NDefines.NCountry.PS_ADD_TRIBAL_LAND_EXTRA_COST_PER_PROVINCE = 10
	
NDefines.NCountry.TRIBE_MIGRATION_NON_TRIBAL_LAND_COOLDOWN_YEARS = 5

NDefines.NCountry.PERCENTAGE_OF_YEARLY_INCOME_FOR_FAVOURS = 0.15
NDefines.NCountry.PERCENTAGE_OF_DEV_FOR_CONVERT_TRIBUTARY_TO_VASSAL = 0.5
NDefines.NCountry.MAX_LIBERTY_DESIRE_FOR_CONVERT_TRIBUTARY_TO_VASSAL = 50

NDefines.NCountry.MIN_NATIONALISM = -35

NDefines.NCountry.DEVOTION_RAZE_TECH_BASE_LEVEL = 3
NDefines.NCountry.DEVOTION_RAZE_TECH_POWER_DECREASE = 0.05 -- Per military tech above base level
NDefines.NCountry.DEVOTION_RAZE_TECH_POWER_DECREASE_MAX = 0.5
NDefines.NCountry.DEVOTION_PER_RAZE = 0.25						-- Devotion gained per development level razed.