...
NDefines.NDiplomacy.AUTONOMY_WARSCORE_COST_MODIFIER = 0			-- How much autonomy reduces score by (at 1 50% autonomy = 50% reduction)
...
NDefines.NDiplomacy.IMPERIAL_CITY_IA = 0.01						-- Monthly per imperial free city
...
NDefines.NDiplomacy.JOIN_HRE_DEVELOPMENT_CAP_VASSAL = 250			-- Max cap of development of vassals to join the empire
...
NDefines.NDiplomacy.LEAVE_HRE_AUTHORITY_PER_DEVELOPMENT = -0.25
...
NDefines.NDiplomacy.ESTATE_DISLIKE_ALLIANCE_ON_VC = -0.15
...
NDefines.NDiplomacy.PEACE_COST_FORCE_OUT_COLONIZERS = 20
...
NDefines.NDiplomacy.AUTODIPLO_TARGET_COALITION_IMPROVE_ABOVE_0_SCORE_BONUS = 25
...
NDefines.NDiplomacy.MIN_MONTHLY_COST_FOR_INFLUENCE_NATION = 10
...
NDefines.NDiplomacy.RIVAL_TRUST_EQUILIBRIUM = 35
...
NDefines.NDiplomacy.DEMAND_UNLAWFUL_TERRITORY_ALLIANCE_DESIRE = -75
