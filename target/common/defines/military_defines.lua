...
NDefines.NMilitary.CAVALRY_COST = 15.0 							-- _MDEF_CAVALRY_COST = 10
NDefines.NMilitary.ARTILLERY_COST = 25.0 							-- _MDEF_ARTILLERY_COST = 10
...
NDefines.NMilitary.TRANSPORT_TIME = 185 							-- _MDEF_TRANSPORT_TIME = 10
...
NDefines.NMilitary.MERCENARY_BASE_COST = 25.0					-- base cost added for a mercenary regiment
NDefines.NMilitary.TRADITION_GAIN_LAND = 15						-- Tradition gain base value from land combat.
NDefines.NMilitary.TRADITION_GAIN_NAVAL = 35						-- Tradition gain base value from naval combat.
...
NDefines.NMilitary.DAYS_PER_PHASE = 1								-- How many days each fire and shock phase lasts
...
NDefines.NMilitary.NAVAL_BASE_ENGAGEMENT_WIDTH = 5   		-- Number of ships that can fire per round
...
NDefines.NMilitary.PASSIVE_DEVASTATION_IMPACT = -1
NDefines.NMilitary.MAX_DRAFT_SIZE_FORCE_LIMIT_RATIO = 0.75
NDefines.NMilitary.MAX_DRAFT_SIZE_TO_YEARLY_INCOME_COST_RATIO = 0.75
NDefines.NMilitary.DRAFTED_TRANSPORT_MEN_RATIO = 0.75
...
NDefines.NMilitary.CAWA_STARTING_MORALE = 0.5
	
NDefines.NMilitary.CREATE_CAWA_MIL_COST = 5
	
NDefines.NMilitary.CAWA_USES_CONSTRUCTION = 0
	
NDefines.NMilitary.SIEGE_BONUS_SUPPLIES_SHORTAGE = 1.0
NDefines.NMilitary.SIEGE_BONUS_FOOD_SHORTAGE = 1.5
